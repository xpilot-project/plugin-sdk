namespace Vatsim.Xpilot.PluginSdk.Models;

/// <summary>
/// A point-in-time snapshot of a controller currently tracked by xPilot.
/// </summary>
public class ControllerInfo
{
    ...
    public ControllerInfo(string callsign, int frequency, double latitude, double longitude)
    {
        Callsign = callsign;
        Frequency = frequency;
        Latitude = latitude;
